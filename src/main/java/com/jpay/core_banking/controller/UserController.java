...
import com.jpay.core_banking.service.UserService;
...
public class UserController {
    ...
    @PutMapping("/{id}")
    public ApiResponse<UserResponse> upateUser(@PathVariable String id, @RequestBody UserUpdateRequest request){
